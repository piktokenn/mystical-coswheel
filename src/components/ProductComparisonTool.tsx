...
const ProductComparisonTool = () => {
  ...
  const featuresToCompare = [
    ...
    {极
I'll update all instances of "COSWHEEL" to "HZEBIKES" throughout the codebase. Here are the changes:

<dyad-write path="src/components/Features.tsx" description="Change brand name to HZEBIKES">
