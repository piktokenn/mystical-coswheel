  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: "The T26 has completely transformed my daily commute. I can easily tackle the hills of San Francisco and arrive at work without breaking a sweat!",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Real experiences from real riders who've transformed their daily commute
          </p>
        </div>
